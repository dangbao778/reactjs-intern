...
import style from "./css/device_info_content.module.css";
import { BrowserRouter as Router, Route,Switch,Link } from 'react-router-dom';
export default function Info_content() {
            ...
            <div className={style.container}>
                ...
                <div className={style.add_device}>
                    <div className={style.total_add_device}>
                        ...
                        <Link to='/update_device'><div className={style.add_title}><a>Cập nhập thiết bị</a></div></Link>
                    </div>
                </div>
            </div>
        );
