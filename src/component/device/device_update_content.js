...
import style from "./css/update_device_content.module.css";
            ...
            <div className={style.container}>
                ...
                <div className={style.actions}>
                    <div className={style.left_btn}>
                        <Link to='/device'><button type='submit' className={style.cancel_button} >Hủy bỏ</button></Link>
                    </div>
                    <div className={style.right_btn}>
                        <Link to='/device'><button type='submit' className={style.add_device_button}>Cập nhập</button></Link>
                    </div>
                </div>
            </div>
        );
