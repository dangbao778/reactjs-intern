...
import style from './css/update_device.module.css';
import img_user_account from "../img/image-account.png"
import { useHistory } from 'react-router-dom';
import { BrowserRouter as Router, Route,Switch,Link } from 'react-router-dom';
import Update_content from './device_update_content';
                    ...
                    <div className={style.top_container}>
                        <div className={style.top_content}>
                            <div className={style.left_title}>
                                <p><a className={style.top_main_title}>Thiết bị > <Link className={style.content} to='./device'>Danh sách thiết bị</Link> > </a> Chi tiết thiết bị</p>
                            </div>
